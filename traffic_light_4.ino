...
int signal1[] = {5, 0, 2};
int signal2[] = {3, 1, 4};
int signal3[] = {A0, A1, A2};
int signal4[] = {A3, 0, A5};
int redDelay = 3000;
int yellowDelay = 1000;
volatile int triggerpin1 = 7;    
volatile int echopin1 = 6;       
volatile int triggerpin2 = 9;     
volatile int echopin2 = 8;        
volatile int triggerpin3 = 12;    
volatile int echopin3 = 13;       
volatile int triggerpin4 = 10;    
volatile int echopin4 = 11;       
...
int t = 15;  // distance under which it will look for vehicles.
...
void loop()
{
  ...
  if (state == LOW){
      Serial.println("The switch: ON");// we have emergency
      for(int i=1; i<3; i++)
    {
